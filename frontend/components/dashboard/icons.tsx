...
export function FileCodeIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      ...
      />
      <path d="M14 2v6h6M9 18l-2-2 2-2M15 14l2 2-2 2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function UserPlusIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M8 11a4 4 0 100-8 4 4 0 000 8zM19 8v6M22 11h-6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function GradCapIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M6 12v5c0 1.66 2.69 3 6 3s6-1.34 6-3v-5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function HistoryIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M3 12a9 9 0 109-9 9 9 0 00-6.36 2.64L3 8" strokeLinecap="round" strokeLinejoin="round" />
...
export function RefreshIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M6.5 9A6 6 0 0018 11M5.5 15A6 6 0 006 13M17.5 15a6 6 0 01-11.5-2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function UsersIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M9 11a4 4 0 100-8 4 4 0 000 8zM23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function MailQuestionIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path
        d="M21 10.5V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h7"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path d="M22 15.5l-3 3-3-3M19 18.5V13" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function UserCogIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M16 21v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M8 11a4 4 0 100-8 4 4 0 000 8z" strokeLinecap="round" strokeLinejoin="round" />
      <path
        d="M19 11l2 .5v1.5l-2 .5m-5.5-.5H3m17 2l1.5 1v1l-1.5 1m-4-2v3l1 .5 1-1 2 1 1-2 1 .5v-1.5l-1-.5M18 14l1 1"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
  ...
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M14 2v6h6M16 13l-4 4-2-2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function PresentationIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M2 3h20M4 3v12h16V3" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 15v6M8 21h8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function GithubIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M12 2C6.48 2 2 6.58 2 12.25c0 4.53 2.87 8.37 6.84 9.72.5.1.68-.22.68-.49v-1.7c-2.78.62-3.37-1.37-3.37-1.37-.45-1.18-1.11-1.5-1.11-1.5-.91-.63.07-.62.07-.62 1 .07 1.53 1.06 1.53 1.06.9 1.58 2.36 1.12 2.94.86.1-.67.35-1.12.63-1.38-2.22-.26-4.56-1.14-4.56-5.06 0-1.12.39-2.03 1.03-2.75-.1-.26-.45-1.3.1-2.7 0 0 .84-.28 2.75 1.05A9.36 9.36 0 0112 6.6c.85 0 1.7.12 2.5.34 1.91-1.33 2.75-1.05 2.75-1.05.55 1.4.2 2.44.1 2.7.64.72 1.03 1.63 1.03 2.75 0 3.93-2.34 4.8-4.57 5.05.36.32.68.94.68 1.9v2.82c0 .27.18.6.69.49A10.25 10.25 0 0022 12.25C22 6.58 17.52 2 12 2z" />
    </svg>
  );
}
...
export function LandmarkIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path
        d="M3 21h18M5 21V10m4 11V10m6 11V10m4 11V10M2 10l10-6 10 6M12 4V2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function UserCheckIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M16 21v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M8 11a4 4 0 100-8 4 4 0 000 8zM16 11l2 2 4-4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function MailIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M4 4h16a2 2 0 012 2v12a2 2 0 01-2 2H4a2 2 0 01-2-2V6a2 2 0 012-2zm0 3l8 5 8-5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function InboxIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M22 12h-7l-2 3h-6l-2-3H2" strokeLinecap="round" strokeLinejoin="round" />
...
export function UsersRoundIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M18 21a8 8 0 00-16 0M10 12a5 5 0 100-10 5 5 0 000 10zM22 20c0-3.37-2-6.5-4-8a5 5 0 00-.45-8.3" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function MailCheckIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M22 13V6a2 2 0 00-2-2H4a2 2 0 00-2 2v12a2 2 0 002 2h8M22 7l-8.97 5.7a1.94 1.94 0 01-2.06 0L2 7M16 19l2 2 4-4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function KeyIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M21 2l-9.6 9.6M7.5 15.5l2.3 2.3a1 1 0 010 1.4l-2.1 2.1a1 1 0 01-1.4 0L4 19M6 13.5l-2.6 2.6L1.8 18l4.2 4.2L9.9 18.6a1 1 0 000-1.4" strokeLinecap="round" strokeLinejoin="round" />
...
export function MagicIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M5 3v4M3 5h4M6 17v4M4 19h4M13 3l.9 2.1L16 6l-2.1.9L13 9l-.9-2.1L10 6l2.1-.9zM19 13l.9 2.1L22 16l-2.1.9L19 19l-.9-2.1L16 16l2.1-.9z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function TrophyIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M6 9H4.5a2.5 2.5 0 010-5H6M18 9h1.5a2.5 2.5 0 000-5H18M8 22h8M12 17v5M7 2h10v7a5 5 0 01-10 0V2z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function CalendarClockIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M21 7.5V6a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h3.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M16 2v4M8 2v4M3 10h18" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <path d="M16 14v2l1.5 1" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function FileSpreadsheetIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M14 2v6h6M8 13h2M8 17h2M8 9h2M14 13h2M14 17h2M14 9h2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function CpuIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M15 2v2M9 2v2M15 20v2M9 20v2M2 15h2M2 9h2M20 15h2M20 9h2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function HashIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M4 9h16M4 15h16M10 3l-2 18M16 3l-2 18" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
