      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-1 rounded-xl border border-brand-softline bg-brand-cream p-1">
          ...
          >
            ...
            <span>Browse SIH 2026 Repository</span>
        ...
        <div className="hidden items-center gap-1 text-xs text-brand-muted lg:flex">
          ...
          <span>Repository in read-only audit mode</span>
        </div>
      </div>
