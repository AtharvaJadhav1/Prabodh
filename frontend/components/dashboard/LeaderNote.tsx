    ...
    <div className="flex items-start gap-3 p-4 rounded-2xl border border-brand-softline bg-white shadow-[0_2px_8px_rgba(91,46,16,0.04)]">
      ...
      {isLead ? (
        <p className="text-xs text-brand-muted">
          <span className="font-bold text-brand-deep">Leader Privilege:</span> Only Aarav Agarwal (Team
          Lead) has permissions to dispatch email invites or accept incoming join requests.
        </p>
      ) : (
        <p className="text-xs text-brand-muted">
